...
|dataset     |positionrank       |tfidf              |singletpr          |singlerank         |lexrank            |topicrank          |textrank           |lexspec            |expandrank         |FIELD11     |FIELD12|FIELD13     |FIELD14|FIELD15      |FIELD16|FIELD17      |FIELD18|FIELD19     |
|------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|------------|-------|------------|-------|-------------|-------|-------------|-------|------------|
